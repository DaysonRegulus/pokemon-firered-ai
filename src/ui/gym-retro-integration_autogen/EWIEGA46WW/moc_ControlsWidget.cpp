/****************************************************************************
** Meta object code from reading C++ file 'ControlsWidget.h'
**
...
#error "The header file 'ControlsWidget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 15, 14), // "bindingChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 7), // "binding"
QT_MOC_LITERAL(4, 39, 6), // "player"
QT_MOC_LITERAL(5, 46, 6) // "accept"

    },
    "ControlsWidget\0bindingChanged\0\0binding\0"
    "player\0accept"
};
...
void ControlsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->bindingChanged((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            using _t = void (ControlsWidget::*)(const QString & , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ControlsWidget::bindingChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ControlsWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ControlsWidget.data,
    qt_meta_data_ControlsWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ControlsWidget::bindingChanged(const QString & _t1, int _t2, int _t3)
{
